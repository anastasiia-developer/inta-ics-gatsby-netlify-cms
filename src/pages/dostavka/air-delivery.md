...
sectionText:
  ...
  text: >-
    ...
    <li>доставка по фіксованій ціні зі збереженням обумовлених умов;


    <li>митне оформлення вантажу;


    <li>викуп і доставка необхідної продукції;


    <li>підтримка і консультації персонального менеджера, який надасть актуальну
    інформацію про поточне місцезнаходження вантажу;</li>
