...
seoSections:
  ...
  sections:
    ...
    - alt: ' inta-ics-доставка-з-китаю-3'
      image: /img/inta_ics_dostavka_z_kitayu-3.jpg
      text: >-
        ## Особливості вантажоперевезень з КНР


        Якщо потрібно перевезти велику партію товару, в залежності від кількості
        і параметрів вантажу викуповується один або кілька контейнерів. В яких
        буде перебувати тільки замовлення клієнта. Подібні перевезення
        називаютьсяFull Container Load(FCL).


        Якщо замовника цікавить дешева доставка з Китаю в Україну, і при цьому
        необхідне транспортування невеликої кількості товарів,
        застосовуєтьсяLess than Container Load(LCL). Так називається тип
        перевезень, коли потрібно оплатити тільки місце, яке займає посилка
        клієнта. В одному контейнері доставляють кілька посилок, які мають
        різних відправників і одержувачів. Поставка консолідованого вантажу
        дозволяє заощадити фінанси, так як замовнику не потрібно платити за весь
        контейнер.


        Перевезення збірних вантажів виконується за одним транспортним
        документом, а значить, скорочується час на оформлення дозвільних
        паперів.


        У компанії є власні склади в Китаї та Україні. Ми здійснюємо контроль за
        процесом доставки товару на всіх етапах проходження. Перевіряємо
        цілісність упаковки посилок, пломбування контейнерів. Доставка з Китаю
        буде виконуватися з урахуванням вимог і бажань замовника, а відстежувати
        місце розташування посилки можна в режимі онлайн. Для цього достатньо
        скористатися додатком INTA-ICS для смартфонів.
    - text: >-
        ## Додаткові послуги під час перевезення вантажів з Китаю


        Крім основних процедур, доставка вантажу з Китаю має на увазі перелік
        додаткових послуг, якими клієнти можуть скористатися за своїм бажанням.
        У них входять:


        * допомога під час переговорів з постачальниками продукції;

        * надання звітів, включаючи фото - та відеозвіти перевірки вантажу;

        * тимчасове зберігання замовленого товару на території наших складів;

        * доставка посилок за точною адресою, яку вкаже клієнт;

        * пошук і викуп товарів з різних китайських сайтів, які спеціалізуються,
        наприклад, на виробництві одягу, електроніки, обладнання.


        Компанія INTA-ICS уважно підходить до кожного замовлення, пропонуючи
        вигідні рішення, ґрунтуючись на можливостях і потребах клієнта. Будь-яка
        доставка товару з Китаю в Україну має на увазі оптимальне співвідношення
        вартості, строків і умов. Ми пропонуємо гнучкі тарифні плани, а кожен
        маршрут розробляється індивідуально для кожного замовника.


        Процедура по проходженню митного огляду буде успішно виконана нашими
        фахівцями.


        Ви можете розраховувати на оперативну обробку даних на замовлення і
        розрахунок вартості транспортування логістами компанії INTA-ICS.
      alt: ' inta-ics-доставка-з-китаю-4'
      image: /img/inta_ics_dostavka_z_kitayu-3.jpg
---
